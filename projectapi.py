...
import sys, json
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "D:\\Projects\\subjective answer evaluation\\key.json"




project_dir = "D:\\Projects\\subjective answer evaluation"
image_file = os.path.join(project_dir, 'a1.png')
